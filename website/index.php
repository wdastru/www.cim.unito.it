		...
		<div id="subsection0">
			<!-- InstanceEndEditable -->
				...
				<div class='paddingOuter'>
					...
					<div class='paddingInner' style="height: 350px;">
												...
												style="width: 100%">
    												<div class="w3-container">
                										...
                										<a href='research/research_imaging_therapy.php'> 
                											<div>
                												<h3 class="punch purple"><span><strong>Imaging &amp; Therapy</strong></span></h3>
                												<br><br>
												...
												style="width: 100%">
    												<div class="w3-container">
														...
														<a href='research/research_cest.php'> 
                											<div> 
                												<h3 class="punch purple"><span><strong>CEST imaging</strong></span></h3>
                												<br><br>
												...
												style="width: 100%">
    												<div class="w3-container">
    													...
    													<a href='research/research_enzyme.php'> 
                											<div> 
                												<h3 class="punch purple"><span><strong>Imaging enzyme activity</strong></span></h3>
                												<br><br>
												...
												style="width: 100%">
    												<div class="w3-container">
                										...
                										<a href='research/research_cell.php'> 
                											<div> 
                												<h3 class="punch purple"><span><strong>Cell labeling and tracking</strong></span></h3>
                												<br><br>
												...
												style="width: 100%">
    												<div class="w3-container">
														...
														<a href='research/research_angiogenesis.php'> 
                											<div> 
                												<h3 class="punch purple"><span><strong>Tumor angiogenesis</strong></span></h3>
                												<br><br>
												...
												style="width: 100%">
    												<div class="w3-container">
    													...
    													<a href='research/research_acidosis.php'> 
                											<div> 
                												<h3 class="punch purple"><span><strong>Tumor acidosis</strong></span></h3>
                												<br><br>
												...
												style="width: 100%">
    												<div class="w3-container">
                										...
                										<a href='research/research_metabolism.php'> 
                											<div> 
                												<h3 class="punch purple"><span><strong>Tumor metabolism</strong></span></h3>
                												<br><br>
								...
								<div
									...
									<div
										...
										<div>
											<img
												style="width: 70%"
												src="news/glint.svg"> <br /> <span>CIM partecipates to the
												H2020 project <a
										...
										<div>
											<img
												style="width: 70%"
												src="news/Identify_logo.jpg"> <br /> <span>CIM partecipates
												to the H2020 project <a
													...
													<div class="w3-container">
														<h4 style="margin-top: 2px; margin-bottom: 2px;">
															<a
																...
																target="_blank"> <b>In vitro and in vivo BNCT
																	investigations using a carborane containing sulfonamide
																	targeting CAIX epitopes on malignant pleural
																	mesothelioma and breast cancer cells.</b>
														
														</h4>
														<span><font color="blue"> <b>Geninatti Crich S et al;</b></font>
														</span>
														<p>
													...
													<div class="w3-container">
														<h4 style="margin-top: 2px; margin-bottom: 2px;">
															<a
																...
																target="_blank"> <b>A novel class of <sup>1</sup>H-MRI
													...
													<div class="w3-container">
														<h4 style="margin-top: 2px; margin-bottom: 2px;">
															<a
																...
																target="_blank"> <b>Efficient Route to Label Mesenchymal
																	Stromal Cell-Derived Extracellular Vesicles.</b>
														
														</h4>
														<span><font color="blue"> <b>Geninatti S. et al; </b></font></span>
														<p>
															<font color="blue">ACS Omega. 2018 Jul 31;3(7):8097-8103.</font>
														</p>
														</a>
													</div>
