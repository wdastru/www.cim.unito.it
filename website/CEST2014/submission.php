                ...
                if (input.files && input.files.length == 1) {
                    ...
                    if (document.getElementById) {
                        if (document.getElementById("file1") != null) {
                            ...
                            var splitLength = parseInt(
                                id.value.split(".").length,
                            );
                            ...
                            if (
                                ...
                                extensionCaseInsensitive.toUpperCase() !=
                                    "DOCX" &&
                                extensionCaseInsensitive.toUpperCase() != "PDF"
                            ) {
                                alert(
                                    "The file has to be a WORD or PDF document",
                                );
                                return false;
                            } else {
                                return true;
                    ...
                    <div class="paddingOuter">
                        ...
                        <div id="CEST-section3">
                            ...
                            <div class="paddingInner">
                                ...
                                <p>
                                    Deadline for submission is 1<sup>st</sup>
                                    March 2014.
                                </p>
                                <p>
                                    The corresponding author will be notified of
                                    the acceptance of his/her abstract and type
                                ...
                                <ul>
                                    ...
                                    <li>
                                        only Word (DOC or DOCX) or PDF documents
                                        are allowed
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        see the
                                        <a
                                            href="documents/ABSTRACT_TEMPLATE.docx"
                                    ...
                                    <li>
                                        you will be able to make changes on your
                                        submission until the submission deadline
                                ...
                                <form
                                    ...
                                    onsubmit="return checkSizeAndExtension();"
                                >
                                    <p>
                                        Submitter&nbsp;:&nbsp;
                                        <input
