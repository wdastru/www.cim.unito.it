            ...
            <div id="subsection4">
                ...
                <div id='content'>
                    <div class='paddingOuter'>
                        <div id='band'>
                            <h1 id='subsectionTitle'>COST Action TD1004 - Private Area</h1>
                        </div>
                        <div class='paddingInner'>
                            <h2 id="mgmtTitle">Workgroup 4 - &quot;Theranostic agents responsive to endogenous and external stimuli&quot;</h2>
                        </div>
                    </div>
                </div>
                <!-- subsection closing -->
