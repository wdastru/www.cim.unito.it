...
$sql = "SELECT * FROM `" . $DBName . "`.`" . $table . "` WHERE `WG` = '" . $WG . "'";
                ...
                <div id='content'>
                    <div class='paddingOuter'>
                        ...
                        <div class='paddingInner'>
                            <h2 id="mgmtTitle">Workgroup 1 - &quot;Imaging reporters for theranostic agents&quot;</h2>
...
<input type='hidden' name='type' value='del'>
                                ...
                                <input type="submit" class="uploadButton" value="+" onclick="changeUploadFormVisibility('uploadButton');" />
                                <form class="uploadForm" action="<?php echo $localizer;?>COST/private/WGs/db.php" method="post" enctype="multipart/form-data" id="uploadButton">
                                    Description:
                                    ...
                                    <input type="hidden" name="path" value="<?php echo $localizer;?>COST/private/WGs/WG1_docs/" />
                                </form>
                            </div>
                        </div>
                    </div>
