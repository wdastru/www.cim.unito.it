...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="confirmDeletionHiddenBox" style="visibility: hidden">
            <h1>WARNING !!!</h1>
            <p style="font-weight: bold">The file will be deleted.</p>
                ...
                <div id="content">
                    <div class="paddingOuter">
                        ...
                        <div class="paddingInner">
                            <h2 id="mgmtTitle">
                                Minutes of the Management Commitee meetings
                            </h2>
                            <div id="minutesContainer">
                                <ul>
                                    <?php $doc = new DOMDocument(); $doc ->
                                    load('minutes.xml'); $books = $doc ->
                                    getElementsByTagName("meeting"); $i = 0;
                                    foreach ($books as $book) { $descriptions =
                                    $book ->
                                    getElementsByTagName("description");
                                    $description = $descriptions -> item(0) ->
                                    nodeValue; $dates = $book ->
                                    getElementsByTagName("date"); $date = $dates
                                    -> item(0) -> nodeValue; $files = $book ->
                                    getElementsByTagName("file"); $file = $files
                                    ...
                                    <li>
                                        <input
                                            ...
                                            type="submit"
                                            value="-"
                                            onclick='showConfirmBox(\"del_$i\")'
                                        />
                                        <a href="uploads/minutes/$file"
                                            >$description ($date)</a
                                        >
                                        <form
                                            class="deleteForm"
                                            action="deleteFromXML.php"
                                            method="post"
                                            id="del_$i"
                                        >
                                            <input
                                ...
                                <input
                                    ...
                                    value="+"
                                    onclick="
                                        changeUploadFormVisibility('uploadForm')
                                    "
                                /><span>(max 8MB)</span><br />
                                <form
                                    class="uploadForm"
                                    action="addToXML.php"
                                    method="post"
