									...
									<div class="12u">
										<p
											...
											<b>Molecular Imaging is a cutting-edge medical technique that
												...
												multifaceted visualization (Fig. 1).<br> Regarding
												...
												sensitive in the physio-pathological pH range.<br> In
												...
												cost effectiveness, when compared to the ELISA counterparts.<br>
												<h1>Future research plans</h1>At the moment, this research
						...
						<!-- <div class="row">
							<div class="3u 6u(mobile)">
								<section>
									...
									<a
										href="<?php echo $localizer; ?>PI/Delli_Castelli/research_1.php">
										<img
											src="<?php echo $localizer; ?>PI/Delli_Castelli/images/research_delli_1.jpg"
											alt=""
							...
							<div class="3u 6u(mobile)">
								<section>
									...
									<a
										href="<?php echo $localizer; ?>PI/Delli_Castelli/research_2.php">
										<img
											src="<?php echo $localizer; ?>PI/Delli_Castelli/images/research_delli_2.jpg"
											alt=""
											class="image featured" />
									</a>
									<a
