<<<<<<< Updated upstream:website/PI/Delli_Castelli/contact.php
<?php
	$localizer = "../../";
?>
<!DOCTYPE html>
			...
			<div class="container">
				...
				<header id="header" style="margin: -30px 0 30px 0;">
					<div class="inner">
						...
						<!-- Logo -->
						<h1>
							<a href="home.php" id="logo">DELLI CASTELLI LAB</a>
							<div>
									...
									<div class="row">
										<div class="6u 12u(mobile)">
											<section>
												...
												Tel: +39 011 6706493<br > 
												Fax: +39 011 6706458<br > 
												<a href="mailto:francesca.reineri@unito.it">daniela.dellicastelli@unito.it</a></font>
												</p>
...
||||||| Stash base:website/PI/Geninatti/contact.html
<!DOCTYPE HTML>
<!--
	ZeroFour by HTML5 UP
	html5up.net | @ajlkn
...
<html>
	<head>
		<title>Contact Us | GENINATTI LAB</title>
...
>>>>>>> Stashed changes:website/PI/Geninatti/contact.html
</html>