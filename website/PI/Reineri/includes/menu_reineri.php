<ul>
	<li class="current_page_item"><a href="<?php echo SITE_ROOT; ?>PI/Reineri/home.php">Home</a></li>
	<li><a href="<?php echo SITE_ROOT; ?>PI/Reineri/research_overview.php">Research</a>
		<ul>
	...
	<li><a href="<?php echo SITE_ROOT; ?>PI/Reineri/publications.php">Publications</a></li>
	<li><a href="<?php echo SITE_ROOT; ?>PI/Reineri/contact.php">Contact us</a></li>
</ul>
