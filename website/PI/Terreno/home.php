						...
						<div class="row">
							...
							<div class="4u 12u(mobile)">
								...
								<section class="box article-list">
									...
									<a href="<?php echo $localizer; ?>#"><img src="images/Terreno.jpg" alt=""
						...
						<div class="row">
							<div class="3u 6u(mobile)">
								<section>
									...
									<a href="<?php echo $localizer; ?>PI/Terreno/research_design.php"><img src="images/Figure_Targeting_Overview_1.jpg" alt="" class="image featured" /></a>
									<a href="<?php echo $localizer; ?>PI/Terreno/research_design.php"><font color="blue">Read more >></font></a>
								</section>
							</div>
							<div class="3u 6u(mobile)">
								<section>
									...
									<a href="<?php echo $localizer; ?>PI/Terreno/research_visualisation.php"><img src="images/Figure_drug_release_overview_2.jpg" alt="" class="image featured" /></a>
									<a href="<?php echo $localizer; ?>PI/Terreno/research_visualisation.php"><font color="blue">Read more >></font></a>
								</section>
							</div>
							<div class="3u 6u(mobile)">
								<section>
									...
									<a href="<?php echo $localizer; ?>PI/Terreno/research_cellularimaging.php"><img src="images/Figure_cellular_imaging_overview_3.jpg" alt="" class="image featured" /></a>
									<a href="<?php echo $localizer; ?>PI/Terreno/research_cellularimaging.php"><font color="blue">Read more >></font></a>
			...
			<footer id="footer" class="container">
				<div class="12u">
					...
					<ul class="menu">
						...
						<li>Updated: 04 December 2018</li>
					</ul>
				</div>
			</footer>
		</div>
