...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo $localizer; ?>html5up-zerofour/assets/css/main.css" />
	</head>
	<body class="homepage is-preload">
						...
						<!-- Header -->
							<header id="header">
								<div class="inner">
									...
									<!-- Logo -->
										<h1><a href="<?php echo $localizer; ?>PI/geninatti/index.php" id="logo">GENINATTI LAB</a></h1>

									<!-- Nav -->
										<nav id="nav">
											<ul>
												<li class="current_page_item"><a href="<?php echo $localizer; ?>PI/geninatti/index.php">Home</a></li>
												<li>
													<a href="#">Dropdown</a>
													<ul>
												...
												<li><a href="<?php echo $localizer; ?>left-sidebar.html">Left Sidebar</a></li>
												<li><a href="<?php echo $localizer; ?>right-sidebar.html">Right Sidebar</a></li>
												<li><a href="<?php echo $localizer; ?>no-sidebar.html">No Sidebar</a></li>
											</ul>
										</nav>
								...
								<section class="container box feature1">
									<div class="row">
										...
										<div class="col-4 col-12-medium">
											<section>
												<a href="#" class="image featured"><img src="<?php echo $localizer; ?>images/pic01.jpg" alt="" /></a>
										...
										<div class="col-4 col-12-medium">
											<section>
												<a href="#" class="image featured"><img src="<?php echo $localizer; ?>images/pic02.jpg" alt="" /></a>
										...
										<div class="col-4 col-12-medium">
											<section>
												<a href="#" class="image featured"><img src="<?php echo $localizer; ?>images/pic03.jpg" alt="" /></a>
											...
											<section class="box article-list">
												...
												<!-- Excerpt -->
													<article class="box excerpt">
														<a href="#" class="image left"><img src="<?php echo $localizer; ?>images/pic04.jpg" alt="" /></a>
														<div>
															<header>
												...
												<!-- Excerpt -->
													<article class="box excerpt">
														<a href="#" class="image left"><img src="<?php echo $localizer; ?>images/pic05.jpg" alt="" /></a>
														<div>
															<header>
												...
												<!-- Excerpt -->
													<article class="box excerpt">
														<a href="#" class="image left"><img src="<?php echo $localizer; ?>images/pic06.jpg" alt="" /></a>
														<div>
															<header>
									...
									<div class="col-4 col-12-medium">
										...
										<!-- Spotlight -->
											<section class="box spotlight">
												...
												<article>
													<a href="#" class="image featured"><img src="<?php echo $localizer; ?>images/pic07.jpg" alt=""></a>
													<header>
		...
		<!-- Scripts -->
			<script src="<?php echo $localizer; ?>html5up-zerofour/assets/js/jquery.min.js"></script>
			<script src="<?php echo $localizer; ?>html5up-zerofour/assets/js/jquery.dropotron.min.js"></script>
			<script src="<?php echo $localizer; ?>html5up-zerofour/assets/js/browser.min.js"></script>
			<script src="<?php echo $localizer; ?>html5up-zerofour/assets/js/breakpoints.min.js"></script>
			<script src="<?php echo $localizer; ?>html5up-zerofour/assets/js/util.js"></script>
			<script src="<?php echo $localizer; ?>html5up-zerofour/assets/js/main.js"></script>
