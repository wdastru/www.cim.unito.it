						...
						<nav id="nav">
							<ul>
								<li class="current_page_item"><a
									href="<?php echo SITE_ROOT; ?>PI/Longo/home.php">Home</a></li>
								<li><a
									href="<?php echo SITE_ROOT; ?>PI/Longo/research_overview.php">Research</a>
									<ul>
										<li><a
											href="<?php echo SITE_ROOT; ?>PI/Longo/research_overview.php">Overview</a></li>
										<li><a
											href="<?php echo SITE_ROOT; ?>PI/Longo/research_probes.php">MRI
												probes</a></li>
										<li><a
								...
								<li><a href="<?php echo SITE_ROOT; ?>PI/Longo/contact.php">Contact
										us</a></li>
							</ul>
						</nav>
					</div>
								...
								<section class="content">
									<div class="12u">
										<p align="justify" style="line-height: 2">
											<b>Our lab aims to develop novel magnetic resonance imaging
												(MRI)-based methods for characterizing tumor
												microenvironment properties (acidosis, vascularization,
												hypoxia) in murine tumor models. We are interested in
												developing and validating non-invasive MRI procedures and
												probes for improving diagnosis and assessment of treatment
												effects with a special focus on tumor metabolism and on
												antiangiogenic drugs. Our studies also focus on assessing pH
												imaging as a novel biomarker in cancer and in renal
												diseases. In addition, we are interested in developing tools
												for improving the FAIRification (findable, accessible,
												interoperable, reusable) of medical image datasets within
												the Open Science concept.<br> Our lab bridges theoretical
												and experimental aspects of biological research, combining
												chemistry, biology and medicine with in vitro and in vivo
												preclinical studies.
											</b>
										</p>
									</div>
									...
									<div>
										<div style="width: 140px;">
											<img
												...
												src="<?php echo SITE_ROOT; ?>PI/Longo/images/Logo-CNR-2010-Quadrato-ENG-high.png"
												alt=""
												style="width: 140px; height: auto; margin-right: 1em;"
												class="image left" />
										</div>
										<div style="padding: 0 0 0 160px;">
											<p align="left" style="line-height: 1.4">
												...
												<br> <font color="#333"> <b>Head, Research Unit of Torino</b>
													<br> Institute of Biostructures and Bioimaging (IBB)<br>
													Italian National Research Council (CNR)<br> <br>Via Nizza,
													52<br> 10126 Torino - Italy<br>
												Tel: <?php
						...
						<div class="row">
							<div class="3u 6u(mobile)">
								<section>
									...
									<a href="<?php echo SITE_ROOT; ?>PI/Longo/research_probes.php"><img
										src="<?php echo SITE_ROOT; ?>PI/Longo/images/overview_probes.jpg"
										alt="" class="image featured" /></a> <a
										href="<?php echo SITE_ROOT; ?>PI/Longo/research_probes.php"><font
							...
							<div class="3u 6u(mobile)">
								<section>
									...
									<a
										href="<?php echo SITE_ROOT; ?>PI/Longo/research_tumor_pH.php"><img
										src="<?php echo SITE_ROOT; ?>PI/Longo/images/overview_tumor_pH.jpg"
										alt="" class="image featured" /></a> <a
										href="<?php echo SITE_ROOT; ?>PI/Longo/research_tumor_pH.php"><font
										color="blue">Read more >></font></a>
								</section>
							</div>
							<div class="3u 6u(mobile)">
								<section>
									<header>
										<h4 font style="text-transform: none;" align="center">MRI-CEST
											RENAL pH IMAGING</h4>
									</header>
									<a href="<?php echo SITE_ROOT; ?>PI/Longo/research_kidney.php"><img
										src="<?php echo SITE_ROOT; ?>PI/Longo/images/overview_kidney.jpg"
										alt="" class="image featured" /></a> <a
							...
							<div class="3u 6u(mobile)">
								<section>
									...
									<a
										href="<?php echo SITE_ROOT; ?>PI/Longo/research_angiogenesis.php"><img
										src="<?php echo SITE_ROOT; ?>PI/Longo/images/overview_angiogenesi.jpg"
										alt="" class="image featured" /></a> <a
										href="<?php echo SITE_ROOT; ?>PI/Longo/research_angiogenesis.php"><font
										color="blue">Read more >></font></a>
								</section>
							</div>
						</div>
								...
								<section class="box article-list">
									...
									<ul class="divided">
										<li>
											...
											</div> <a href="https://www.ismrm.org/22m/"
										...
										<li>
											...
											href="https://e-smi.eu/meetings/emim/past-meetings/2022-2/"
											style="vertical-align: middle; padding-left: 10px"
										...
										<li>
											...
											</div> <a href="https://www.cestworkshop.org/"
											style="vertical-align: middle; padding-left: 10px"
								...
								<section class="box spotlight">
									...
									<ul class="divided">
										...
										<li><b>New research article on tumor pH imaging for assessing
											...
											href="https://pubmed.ncbi.nlm.nih.gov/33257841"
											target="_blank"> <em><font color="blue">Brisith Journal of
														Cancer 2021; 124, 207.</font></em></a> <br> <video
												oncontextmenu="return false;" width="320" height="240"
												controls controlsList="nodownload" loop>
												<source
													src="<?php echo SITE_ROOT; ?>PI/Longo/images/pH_imaging_bjc.mp4"
													type="video/mp4">
										...
										<li><b>New research article on a novel multislice sequence for
											...
											title="Open in a new window" class="http"
											href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7782702/"
											target="_blank"> <em><font color="blue">Magnetic Resonance in
														Medicine 2021; 85:1335-1349.</font></em></a> <br>
											<p>
												<b>The multislice MRI-CEST sequence is freely available <a
													class="http"
										...
										<li><img
											...
											style="margin-right: 10px; margin-bottom: 80px"> <b>New book
												chapters describing basic concepts, acquisition and analysis
												protocols in preclinical DCE-MRI and CEST pH imaging in
												kidneys. </b><br> <a title="Open in a new window"
											class="http"
