		...
		<div class="main-area">
			<div id='sidebar'></div><div id='content'>
				<div class='paddingOuter'>
					...
					<div>
							<div>						
								<img src="<?php echo SITE_ROOT; ?>images/staff/garello.jpg" style="max-width: 150px; margin-left:0px;" />
							</div>
							<div>
								<h1 style="color:#666666; text-align:left; padding-left:0px;">Francesca Garello</h1>
					...
					<div>
							<h2>Research Topics</h2>
								<img src="<?php echo SITE_ROOT; ?>images/wordcloud/garello_wordcloud.png" style="max-width: 250px;" />
							</div>
					</div>
						<hr></hr>
					<div class="row" >
					...
					E-mail: <a href="mailto:francesca.garello@unito.it"><span style="color:#007c92">francesca.garello@unito.it</span></a></p>
					</div>
					   <hr></hr>
					<div class="row" >
					<h2 style="color:#8c1515; text-align:left;">Publications</h2>
					<p>Full list of publications are available at 
									<a title="Open in a new window" href="https://www.ncbi.nlm.nih.gov/pubmed/?term=Francesca+Garello" target="_blank" style="color:#007c92">PubMed </a>
					</div>
					</div>
				</div>
			</div>
