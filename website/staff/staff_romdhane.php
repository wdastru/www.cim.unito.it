		...
		<div class="main-area">
			<div id='sidebar'></div><div id='content'>
				<div class='paddingOuter'>
					...
					<div>
							<div>						
								<img src="../images/staff/romdhane.jpg" style="max-width: 150px; margin-left:0px;" />
							</div>
							<div>
								<h1 style="color:#666666; text-align:left; padding-left:0px;">Feriel Romdhane</h1>
					...
					<div>
							<h2>Research Topics</h2>
								<img src="../images/wordcloud/romdhane_wordcloud.png" style="max-width: 250px;" />
							</div>
					</div>
						<hr></hr>
					<div>
					...
					E-mail: <a href="mailto:ferielromdhane@yahoo.fr"><span style="color:#007c92">ferielromdhane@yahoo.fr</span></a></p>
					</div>
					   <hr></hr>
					<div>
