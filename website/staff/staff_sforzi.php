		...
		<div class="main-area">
			<div id='sidebar'></div><div id='content'>
				<div class='paddingOuter'>
					...
					<div>
							<div>						
								<img src="<?php echo SITE_ROOT; ?>images/staff/sforzi.webp" style="max-width: 150px; margin-left:0px;" />
							</div>
							<div>
								<h1 style="color:#666666; text-align:left; padding-left:0px;">Jacopo Sforzi</h1>
								<p style="text-align:left;"><b>PhD student<br>
								Department of Molecular Biotechnology and Health Sciences<br>
								<a href="<?php echo SITE_ROOT; ?>PI/Geninatti/home.php" target="_blank" style="color:#dc6a10">
								 Geninatti Lab</a>
								</b></p>
							</div>
						</div>
					...
					<p>The aim of my research is the development and characterization of a fast and reliable fluorimetric assay 
												for the detection of nucleic acids biomarkers in biological matrixes.
												We are focusing on the creation of a liposome based fluorescent probe, in order to detect very low 
												concentrations of biomarkers involved in many different disease, from cancer, to infective and inflammatory 
												pathologies, trying to improve diagnostic and therapeutic insights of common medical protocols and procedures.</p>
					</div>
					</div>
						<hr></hr>
					<div class="row" >
