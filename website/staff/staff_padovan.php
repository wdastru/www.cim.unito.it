				...
				<div class='paddingOuter'>
					...
					<div class="w3-row" >
							<div class="w3-col w3-quarter">						
								...
								<img src="../images/padovan.jpg" class="w3-image"
					...
					<h2 style="color:#8c1515; text-align:left;">Education</h2>
						<p style="line-height: 1.5">
												 <br>
												Secondary School Diploma in Chemistry, Italy<br>
											</p>
					...
					<p>Full list of publications are available at 
									<a title="Open in a new window" href="https://www.ncbi.nlm.nih.gov/pubmed/?term=Sergio+Padovan" target="_blank" style="color:#007c92">PubMed </a>
