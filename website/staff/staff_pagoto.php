		...
		<div class="main-area">
			<div id='sidebar'></div><div id='content'>
				<div class='paddingOuter'>
					...
					<div>
							<div>						
								<img src="../images/staff/pagoto.jpg" style="max-width: 150px; margin-left:0px;" />
							</div>
							<div>
					...
					<div>
							<h2>Research Topics</h2>
								<img src="../images/wordcloud/pagoto_wordcloud.png" style="max-width: 250px;" />
							</div>
					</div>
						<hr></hr>
					<div>
					...
					E-mail: <a href="mailto:amerigo.pagoto@unito.it"><span style="color:#007c92">amerigo.pagoto@unito.it</span></a></p>
					</div>
					   <hr></hr>
					<div>
					<h2 style="color:#8c1515; text-align:left;">Publications</h2>
					<p>Full list of publications are available at 
									<a title="Open in a new window" href="https://www.ncbi.nlm.nih.gov/pubmed/?term=Amerigo+Pagoto" target="_blank" style="color:#007c92">PubMed </a></p>
					</div>
					</div>
				</div>
			</div>
