		...
		<div class="main-area">
			<div id='sidebar'></div><div id='content'>
				<div class='paddingOuter'>
					...
					<div>
							<div>						
								<img src="../images/staff/capuana.jpg" style="max-width: 150px; margin-left:0px;" />
							</div>
							<div>
					...
					E-mail: <a href="mailto:federico.capuana@unito.it"><span style="color:#007c92">federico.capuana@unito.it</span></a></p>
					</div>
					   <hr></hr>
					<div class="row" >
					<h2 style="color:#8c1515; text-align:left;">Publications</h2>
					<p>Full list of publications are available at 
									<a title="Open in a new window" href="https://www.ncbi.nlm.nih.gov/pubmed/?term=Federico+Capuana" target="_blank" style="color:#007c92">PubMed </a>
					</div>
					</div>
				</div>
			</div>
