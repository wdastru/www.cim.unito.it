		...
		<div class="main-area">
			<div id='sidebar'></div><div id='content'>
				<div class='paddingOuter'>
					...
					<div>
							<div>
								<img src="<?php echo SITE_ROOT; ?>images/staff/anemone.jpg" style="max-width: 150px; margin-left:0px;" />
							</div>
							<div>
					...
					<p>My project focuses on exploiting  MRI-CEST pH imaging as a non&minus;invasive in vivo molecular imaging techniques
										...
										I am also interested in using this novel technique for assessing treatment response to inhibitors of cancer metabolism and
										 to drugs targeting proton pumps.</p>
					</div>
					</div>
						<hr></hr>
					<div class="row" >
					...
					E-mail: <a href="mailto:annasofia.anemone@gmail.com"><span style="color:#007c92">annasofia.anemone@gmail.com</span></a></p>
					</div>
					   <hr></hr>
					<div class="row" >
					<h2 style="color:#8c1515; text-align:left;">Publications</h2>
					<p>Full list of publications are available at
									<a title="Open in a new window" href="https://www.ncbi.nlm.nih.gov/pubmed/?term=Annasofia+Anemone" target="_blank" style="color:#007c92">PubMed </a>
					</div>
					</div>
				</div>
			</div>
