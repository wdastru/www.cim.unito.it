		...
		<div class="main-area">
			<div id='sidebar'></div><div id='content'>
				<div class='paddingOuter'>
					...
					<div>
							<div>						
								<img src="../images/staff/tripepi.jpg" style="max-width: 150px; margin-left:0px;" />
							</div>
							<div>
								<h1 style="color:#666666; text-align:left; padding-left:0px;">Martina Tripepi</h1>
					...
					<p>Full list of publications are available at 
									<a title="Open in a new window" href="https://www.ncbi.nlm.nih.gov/pubmed/?term=Martina+Tripepi" target="_blank" style="color:#007c92">PubMed </a>
					</div>
					</div>
				</div>
			</div>
