		...
		<div class="main-area">
			<div id='sidebar'></div><div id='content'>
				<div class='paddingOuter'>
					...
					<div>
							<div>						
								<img src="<?php echo SITE_ROOT; ?>images/staff/baroni.webp" style="max-width: 150px; margin-left:0px;" />
							</div>
							<div>
					...
					<div>
							<h2>Research Topics</h2>
								<img src="../images/wordcloud/baroni_wordcloud.png" style="max-width: 250px;" />
							</div>
					</div>
						<hr></hr>
					<div class="row" >
