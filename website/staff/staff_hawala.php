		...
		<div class="main-area">
			<div id='sidebar'></div><div id='content'>
				<div class='paddingOuter'>
					...
					<div>
							<div>						
								<img src="../images/staff/hawala.jpg" style="max-width: 150px; margin-left:0px;" />
							</div>
							<div>
					...
					<p>Full list of publications are available at 
									<a title="Open in a new window" href="https://www.ncbi.nlm.nih.gov/pubmed/?term=Ivan+Hawala" target="_blank" style="color:#007c92">PubMed </a>
					</div>
					</div>
				</div>
			</div>
