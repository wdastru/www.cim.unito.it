				...
				<div class='paddingOuter'>
					...
					<div class='paddingInner'>
						...
						<p class="indent">
							...
							service for archiving and processing preclinical medical images
							is available at
							<a
								href="http://eubi-xnat.hpc4ai.unito.it"
								target="_blank"
								style="color: #dc6a10">EUBI-XNAT</a>
							. <br> Small animal imaging facilities are highly specialized
							centers that provide the research community access to
							cutting-edge imaging technologies. These centers have therefore
							to deal with the complexity and the variety of preclinical image
							datasets in terms of archiving and retrieving image datasets as
							well as for the management and processing. To date, no custom or
							standard solutions are available to imaging centers to fullfill
							these tasks.<br> XNAT natively supports multiple imaging
							modalities, such as MR, PET, CT, and US. We are extending XNAT
							datatypes to other preclinical imaging modalities, such as
							Optoacoustic (OA) and Optical Imaging (OI).
						</p>
						<div class="imgLeft">
							<img
								alt="XNAT"
