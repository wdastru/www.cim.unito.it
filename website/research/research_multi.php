            ...
            <div id="subsection5">
                ...
                <div id='content'>
                    <div class='paddingOuter'>
                        <div class='band'>
                            <h1 class='subsectionTitle'><!-- InstanceBeginEditable name="subsection title" -->Multi-modality Contrast Agents <!-- InstanceEndEditable --></h1>
                        </div>
                        <div class='paddingInner'>
                            ...
                            <p class='indent'>
                                ...
                                single photon emission computed tomography (SPECT) in association with each other or with the anatomic reference provided by computed tomography (CT) as well as with anatomic 
                                and functional information provided by magnetic resonance imaging (MRI) have all been proficiently applied to animal models of human disease (Figure 1).
