<?php
    ...
    $activeSubsection = 'imaging-therapy';
?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div class='paddingOuter'>
					...
					<div class='paddingInner'>
						<p class="indent">
							...
							therapeutic effect.<br> Most of the theranostic procedures
							...
							&quot;personalized medicine&quot;.<br> Theranosis is intimately
							...
							nanocarrier.<br> Another important application area of Theranosis
							...
							cells after their injection.<br> However, imaging can support not
							...
							vision for making clinical decision during interventions.<br> <br>
							In our Center, several theranostic procedure have been developed
							and preclinically validated aimed at: <br>
						</p>
						<ul>
							<li>monitoring by MRI the biodistribution of a drug transported
								by a given nanocarrier (liposomes, PLGA micelles, apoferritin)</li>
							<li>assessing by MRI the release of a drug (e.g. doxorubicin)
								from a nanocarrier (liposomes) triggered by a local application
								of low intensity ultrasound</li>
							<li>providing a fluorescent guide to discriminate tumor and
								healthy tissue in prostatectomy</li>
						</ul>
						<hr>
