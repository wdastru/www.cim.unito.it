				...
				<div class='paddingOuter'>
					...
					<div class='paddingInner'>
						...
						<p class='indent'>
							...
							Resonance Imaging applications. Complexes of Gd<sup>3+</sup> ion
							...
							rates (R<sub>1</sub> and R<sub>2</sub>) of the water protons in
							the regions where they distribute. Actually, Gd<sup>3+</sup> ion
							(seven unpaired electrons, long electronic relaxation time) was
							immediately recognized as the paramagnetic ion of choice.<br>
							...
							wrap around the Gd<sup>3+</sup> ion to form highly stable
							...
							as potential CAs for in vivo applications. <br> The chemistry of
						...
						<ul>
							<li><b> Small-molecular weight Gd-complexes</b>
								<p class="indent">
									Unspecific hydrophilic chemicals to visualize tumor perfusion
									or abnormalities in organ function or as
									<a
										href="research_responsive.php"
										style="color: #dc6a10">responsive agents</a>
									to tissue microenvironment parameters.
								</p></li>
							<li><b>Blood-pool agents</b>
								<p class="indent">
									Gd-complexes functionalized with hydrophobic moieties which
									enable the binding to human serum albumin in order to increase
									relaxivity and the retention time in blood vessels. These
									complexes find application also in quantitative assessments of
									<a
										href="research_angiogenesis.php"
										style="color: #dc6a10">tumor angiogenesis</a>
									by exploiting DCE-MRI (Dynamic Contrast Enhanced-MRI)
									approaches.
								</p></li>
							<li><b>Macromolecular agents</b>
								<p class="indent">Gd-complexes are incorporated in high
									molecular weight systems either as part of supramolecular
									assemblies such as liposomes or micelles and as multimers of
									Gd-complexes (dimers, tetramers, dendrimers).</p></li>
						</ul>
						<hr>
        ...
        <div id='section1'>
            ...
            <div id="subsection2">
                ...
                <div id='content'>
                    <div class='paddingOuter'>
                        <div id='band'>
                            <h1 id='subsectionTitle'><!-- InstanceBeginEditable name="subsection title" -->Gadolinium&minus;based Contrast Agents <!-- InstanceEndEditable --></h1>
                        </div>
                        <div class='paddingInner'>
                            <!-- InstanceBeginEditable name="subsection content" -->
                            <p class='indent'>
                               ...
                               <ul>
                                <li><b> Small-molecular weight Gd-complexes</b>
                                <p class="indent">
                                    Unspecific hydrophilic chemicals to visualize tumor perfusion or abnormalities in organ function or as <a href="research_responsive.php" style="color:#dc6a10">responsive agents</a>
                                     to tissue microenvironment parameters.
                                    </p></li>
                               
                               <li><b>Blood-pool agents</b>
                                    <p class="indent">
                                     Gd-complexes functionalized with hydrophobic moieties which enable the binding to human serum albumin in order to increase relaxivity and the retention time in blood vessels. 
                                     These complexes find application also in quantitative assessments of <a href="research_angiogenesis.php" style="color:#dc6a10">tumor angiogenesis</a> by exploiting DCE-MRI (Dynamic Contrast Enhanced-MRI) approaches.                               
                                    </p></li>
                                    
                                <li><b>Macromolecular agents</b>
                                    <p class="indent">
                                        Gd-complexes are incorporated in high molecular weight systems either as part of supramolecular assemblies such as liposomes or micelles and as multimers of Gd-complexes
                                         (dimers, tetramers, dendrimers). 
