				...
				<div class='paddingOuter'>
					...
					<div class='paddingInner'>
						...
						<p class='indent'>
							...
							improvement.<br> Researches related to tumour metabolism are
							...
							hallmark of cancer.<br> Glycolysis is an early attractive target
        ...
        <div id='section1'>
            ...
            <div id="subsection15">
                ...
                <div id='content'>
                    <div class='paddingOuter'>
                        <div id='band'>
                            <h1 id='subsectionTitle'><!-- InstanceBeginEditable name="subsection title" -->Tumor metabolism <!-- InstanceEndEditable --></h1>
                        </div>
                        <div class='paddingInner'>
                            <!-- InstanceBeginEditable name="subsection content" -->
                            <p class='indent'>
