...
<div class="lab">
          ...
          <div class="hexagon hexagon2">
            ...
            <a title="Homepage" href="PI/Longo/home.php" target="_blank">
                ...
                <p class="hexagon-middle-text"><b>Research Fellow</b></p></a>                   
					...
					<h1><span style="text-align:left">Research Fellows</span></h1>
					<div class="lab">
					<article> 
	...
	<div class='paddingInner'>
		...
		<h1>
			<span style="text-align: center">Imaging Probe Chemistry Center
				(IPCT)</span>
		</h1>
	...
	<div class='paddingInner'>
		...
		<h1>
			<span style="text-align: center">IBB-CNR Torino Unit</span>
		</h1>
