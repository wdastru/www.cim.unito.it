					...
					<div class='paddingInner'>
						<p style='text-align: justify'>
							...
							<a
								...
								target='_blank'>
								<span class='paperTitle'>Bioindustry Park</span>
							</a>
							...
							Biotechnology.<br> Since 2009 it hosts a research unit of the
							<a
								href='http://www.ibb.cnr.it/'
								target='_blank'>
								<span class='paperTitle'><b>Institute of Biostructures and
										Bioimages (IBB)</b></span>
							</a>
							of the Consiglio Nazionale delle Ricerche (CNR) in the context of
									...
									target="_blank"><span class='paperTitle'>Center of Excellence
										...
										Torino, located at the School of Biotechnology.<br> Since 2009
											...
											href="http://www.ibb.cnr.it/" target="_blank"><span
												class='paperTitle'><b>Institute of Biostructures and
														Bioimages (IBB)</b></span></a> of the Consiglio Nazionale
						...
						<div class="w3-row-padding" style="background: #E6E6E6;">
							<div class="w3-container">
								...
								<div class="w3-quarter">
									<div class="w3-container">
										<a title="Opens in new window"
											href="research/research_synthesis.php"><div class="w3-header"
												style="height: 70px;">
										...
										<a title="Opens in new window" href="#"><span class="PIname">
												Stefania</span></a>, <a title="Opens in new window" href="#">
									...
									<div class="w3-container">
										<a title="Opens in new window"
											...
											title="Opens in new window" href="#"><span class="PIname">
												Gianolio</span></a>, <a title="Opens in new window" href="#"><span
								...
								<div class="w3-quarter">
									<div class="w3-container">
										<a title="Opens in new window"
											href="research/research_cest.php"><div class="w3-header"
												style="height: 70px;">
											...
											alt="" class="w3-image-left" /></a> <span class="PIname">PI:
										</span> <a title="Opens in new window" href="#"><span
								...
								<div class="w3-quarter">
									<div class="w3-container">
										<a title="Opens in new window"
											href="research/research_hyper.php"><div class="w3-header"
												style="height: 70px;">
						...
						<div class="w3-row-padding" style="background: #E6E6E6;">
							<div class="w3-container">
								...
								<div class="w3-quarter">
									<div class="w3-container">
										<a title="Opens in new window"
											href="research/research_multi.php"><div class="w3-header"
												style="height: 70px;">
											...
											class="w3-image-left" /> </a><span class="PIname">PI: </span>
										<a title="Opens in new window" href="#"><span class="PIname">
												Terreno</span></a>, <a title="Opens in new window" href="#"><span
									...
									<div class="w3-container">
										<a title="Opens in new window"
											href="research/research_responsive.php"><div
												class="w3-header" style="height: 70px;">
									...
									<div class="w3-container">
										<a title="Opens in new window"
											href="research/research_nanotarget.php"><div
												class="w3-header" style="height: 70px;">
												<h13 font style="text-transform: none;"> <font color="red">Targeting
												agents</font></h13>
											</div> <img
