...
<!-- InstanceBeginEditable name="subsection title" -->Hyperpolarization
...
added to cells suspensions for MRI/MRS acquisitions.</div>
...
transfer to heteronuclei occurs via scalar couplings.</div>
<div class='content'>
<p class='indent'>An hyperpolarized state is defined as a state in
...
low natural abundance of heteronuclei such as <sup>13</sup>C and
<sup>15</sup>N. With hyperpolarized contrast agents, images are
...
methodology.</p>
<p class='indent'>At CIM, the PHIP procedure is used to produce
...
<p class='indent'><b>1) Novel substrates for
para-hydrogenation.</b></p>
...
alt="p-Hydrogenation" style="width:500px;" /></div>
<p class='indent'><b>2) Quick methods for the catalyst and organic
solvent removal after para-hydrogenation</b></p>
...
exchange chromatogrophy</p>
<p class='indent'>All the three possibilities are studied at the
CIM.</p>
<p class='indent'>The second methodology is of particular interest
...
anhydride in chloroform and subsequent hydrolysis.</p>
<p class='indent'><b>3) Procedures to convert the <sup class=
'superscript'>13</sup>C anti-phase signal obtained after
para-hydrogenation to in-phase signal (suitable for MRI)</b></p>
<div class='imgRight'><img src=
"images/Hyperpolarization/hyper-heart.jpg" alt=
"heart 13C image" /></div>
<p class='indent'>Polarization transfer from para-hydrogen to
...
the para-hydrogenated sample.</p>
</div>
