...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>
            Molecular Imaging Center - University of Torino - Publications
        </title>
        <meta
            name="description"
            content="Publications from people at the Molecular Imaging Center"
        />
        <script src="scriptLongPubs.js" type="text/javascript"></script>
    </head>
    <body>
            ...
            <div id="pubSubSectOpen">
                <div id="subsection0">
                    <div id="sidebar-narrow">
                        <div class="padding">
                            <?php $today = getdate(); echo "<select
                                id="pubsSelector"
                                onchange="showPubs(this)"
                            >
                                "; $lastYear = $today['year']; $firstYear =
                                1974; for ($year=$lastYear; $year>=$firstYear;
                                $year--) echo "
                                <option value='" . $year . "'>
                                    " . $year . "
                                </option>
                    ...
                    <div id="content-large">
                        <div class="paddingOuter">
                            <div id="band">
                                <h1 id="subsectionTitle">Publications</h1>
