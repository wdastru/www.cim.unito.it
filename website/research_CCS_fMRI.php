...
<div id='section1'><?php require('includes/main-nav.php'); ?>
<div id='header'></div>
<!-- InstanceBeginEditable name="subsection opening" -->
<div id="subsection8"><!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="subsection title" -->
 Research at CCS fMRI <!-- InstanceEndEditable --></h1>
</div>
...
<p class="indent">Up until now, our research projects using the 1.5
...
<p class="indent">Walking rehabilitation in patients with paresis
