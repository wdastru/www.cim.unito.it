...
<div class="row">
			<div class="w3-container">
				...
				<div class="square bg"
					...
					<div class="content">
						<div class="table">
						<a title="Homepage" href="PI/Geninatti/home.php" target="_blank">
							<div class="table-cell">
								<h2 style="font-size: 20px;">
							...
							<div class="row">
								<div class="w3-container">
									...
									<div class="square bg"
										...
										<div class="content">
											<div class="table">
											<a title="Profile" href="staff/staff_romdhane.php">
												<div class="table-cell">
													<h2 style="font-size: 20px;">
														<b>Feriel Romdhane</b>
													</h2>
									...
									<div class="square bg"
										...
										<div class="content">
											<div class="table">
											<a title="Profile" href="staff/staff_tear.php">
												<div class="table-cell">
													<h2 style="font-size: 20px;">
														<b>Louise Tear</b>
													</h2>
							...
							<div class="row">
								<div class="w3-container">
									...
									<div class="square bg"
										...
										<div class="content">
											<div class="table">
											<a title="Profile" href="staff/staff_sforzi.php">
												<div class="table-cell">
													<h2 style="font-size: 20px;">
														<b>Jacopo Sforzi</b>
													</h2>
									...
									<div class="square bg"
										...
										<div class="content">
											<div class="table">
											<a title="Profile" href="staff/staff_furlan.php">
												<div class="table-cell">
													<h2 style="font-size: 20px;">
														<b>Chiara Furlan</b>
													</h2>
									...
									<div class="square bg"
										...
										<div class="content">
											<div class="table">
											<a title="Profile" href="staff/staff_palagi.php">
												<div class="table-cell">
													<h2 style="font-size: 20px;">
														<b>Lorenzo Palagi</b>
													</h2>
									...
									<div class="square bg"
										...
										<div class="content">
											<div class="table">
											<a title="Profile" href="staff/staff_dhakan.php">
												<div class="table-cell">
													<h2 style="font-size: 20px;">
														<b>Chetan Dhakan</b>
													</h2>
									...
									<div class="square bg"
										...
										<div class="content">
											<div class="table">
											<a title="Profile" href="staff/staff_villano.php">
												<div class="table-cell">
													<h2 style="font-size: 20px;">
														<b>Daisy Villano</b>
													</h2>
