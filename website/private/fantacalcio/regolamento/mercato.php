        ...
        <table class="regole">
          ...
          <tr>
            <td align="justify"><p class="justify">Prima dell'inizio di ogni stagione, ciascuna squadra deve comunicare gli 11 giocatori della propria rosa che intende mantenere; gli altri risulteranno automaticamente sul mercato.</p>
              ...
              <p class='justify'> al momento della comunicazione degli 11 ), a questa cifra andr� aggiunto un importo in fmil calcolato, per ciascun giocatore, con la formula: 51 � (posizione della squadra a cui � stato ceduto), fino ad un massimo di 100 fmil. </p>
              ...
              <p class='link center'><a style="text-decoration:none" href="http://www.xs4all.nl/~kassiesa/bert/uefa/data/method4/trank2009.html">http://www.xs4all.nl/~kassiesa/bert/uefa/data/method4/trank2009.html</a></p>
              <p class='justify'> 
                la sua squadra, nel momento in cui questo viene tagliato per acquistare un altro giocatore, recuperer� un importo in fmil calcolato, per ciascun giocatore, con la formula: 51 � (posizione della squadra a cui � stato ceduto), fino ad un massimo complessivo di 100 fmil per squadra.</p>
