  ...
  <table class="regole">
    ...
    <tr>
      <td><p class="justify">I giocatori che portano punti sono solo gli 11 che &quot;scendono in campo&quot;, cio&eacute; i titolari che hanno ottenuto punteggio e i giocatori della panchina che hanno sostituito i titolari senza voto.</p>
        ...
        <p class="justify">Se necessario, il software tenter� di modificare il modulo (tra quelli consentiti) in modo da 
        evitare di giocare in inferiorit� numerica (o comunque in modo da giocare con il n. maggiore possibile di giocatori).</p>
        <p class="justify">Nel tentativo di cambio modulo, partir� dal modulo impostato provando, in ordine, prima moduli con offensivit� via via 
        crescente (ossia spostandosi verso il 3-4-3) e poi, se necessario, moduli con offensivit� via via decrescente (ossia 
        spostandosi verso il 5-4-1), assegner� i nuovi titolari in base all�ordine inserito dei giocatori di ciascun ruolo 
        (per es.: nel passaggio dal 3-4-3 al 4-3-3 il quarto difensore indicato diventer� titolare ed il quarto centrocampista 
        indicato diventer� prima riserva) e poi partir� con le eventuali sostituzioni per ruolo (sempre fino ad un massimo di 
        tre).</p>
        <p class="justify">Il software effettuer� il cambio di modulo solo se tutti i titolari originali con voto saranno nella squadra 
        ...
        aumentare il n. di giocatori con voto, verr� mantenuto il modulo iniziale e la squadra giocher� in inferiorit� numerica.</p>
