<div id='menu'>
  <div class='chromestyle' id='chromemenu'>
    <ul>
      ...
      <li id='dropmenuli5'> <a href='<?php echo $relocate_string; ?>#' rel='dropmenu5'>Risultati</a> </li>
      <li id='dropmenuli1'> <a href='<?php echo $relocate_string; ?>#' rel='dropmenu1'>Marcatori</a> </li>
      <li id='dropmenuli2'> <a href='<?php echo $relocate_string; ?>#' rel='dropmenu2'>Squadre</a> </li>
      <li id='dropmenuli3'> <a href='<?php echo $relocate_string; ?>#' rel='dropmenu3'>Regole</a> </li>
      <li id='dropmenuli4'> <a href='<?php echo $relocate_string; ?>#' rel='dropmenu4'>Albo d'oro</a> </li>
  ...
  <div id='dropmenu2' class='dropmenudiv'> 
    ...
    <a href='<?php echo $relocate_string; ?>squadre/squadra.php?squadra=patelavache'>Ij&nbsp;Patelavache</a>
  ...
  <div id='dropmenu3' class='dropmenudiv'> 
	...
	<a href='<?php echo $relocate_string; ?>regolamento/comunicare_ris.php'>Comunicare&nbsp;risultato</a> 
