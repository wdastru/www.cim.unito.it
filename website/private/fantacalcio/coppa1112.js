 ...
 * 
 * squadra[i][0] -> nome squadra[i][1] -> punti squadra[i][3] -> vinte
 * squadra[i][4] -> pareggiate squadra[i][5] -> perse squadra[i][6] -> fatti
 * squadra[i][7] -> subiti squadra[i][8] -> diff reti squadra[i][9] -> punti
 * fatti squadra[i][10] -> diff punti squadra[i][11] -> short name
 * 
 ******************************************************************************/
 ...
 */
	...
	/***************************************************************************
	 * 
	 * avulsa[i][0] -> nome avulsa[i][1] -> punti avulsa[i][2] -> giocate
	 * avulsa[i][3] -> vinte avulsa[i][4] -> pareggiate avulsa[i][5] -> perse
	 * avulsa[i][6] -> fatti avulsa[i][7] -> subiti avulsa[i][8] -> diffReti
	 * avulsa[i][9] -> punti fatti avulsa[i][10] -> differenza punti
	 * 
	 **************************************************************************/
	...
	for (i = 0; i < 12; i++) // partite della fase a gruppi
	{
		...
		} else if (datiCoppaPerAvulsa[i][3] > datiCoppaPerAvulsa[i][2]) // vittoria
		// "fuori"
		{
			// alert("fuori");
			for (k = arguments[1][0]; k <= arguments[1][arguments[1].length - 1]; k++) {
