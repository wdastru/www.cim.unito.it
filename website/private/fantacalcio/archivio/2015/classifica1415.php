...
require_once $relocate_string . 'archivio/2015/squadre1415.inc';
require_once $relocate_string . 'archivio/2015/calendario1415.inc';
require_once $relocate_string . 'archivio/2015/classifica1415.inc.php';

$datiCampionatoFileName = $relocate_string . 'archivio/2015/datiCampionato1415.txt';
?>
...
xmlns="http://www.w3.org/1999/xhtml">
	...
	<!--<body onload="startBanner(1)">-->
		...
		<div id="main">
			...
			<h1 class="title">XVI Campionato Fantacalcio NMR 2014/15</h1>
			<br />
        <br />
        <h2 class='firstClass'>1&deg; Classificato: </h2>
        <h2 class="title">EPOrediese</h2>
        <br />
			...
			require $relocate_string . 'archivio/2015/functions1415.inc.php';
