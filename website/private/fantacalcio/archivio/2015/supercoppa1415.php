...
<?php require $relocate_string . 'include/menu.inc.php'; ?>
	...
	<div id="main">
		...
		<h1 class="title">SUPERCOPPA 2015</h1>
		<br />
			...
			<tr>
				<td><table align="center" width="150" border="0">
						...
						<tr>
							...
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td colspan="3" class="goalDestra">3</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
							<td colspan="19" class="goalSinistra">Lokomotiv Peccorino</td>
						</tr>
					</table></td>
			</tr>
			<tr>
		...
		<p>
          EPOrediese           : 3 ( 80.5 : ICARDI, ICARDI, ZAZA ) 
          <br/>
          Lokomotiv PECCORINO  : 2 ( 74.5 : BONAVENTURA, BONAVENTURA )
		</p>
		<!-- InstanceEndEditable -->
	</div>
