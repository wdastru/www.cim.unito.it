...
require_once $relocate_string . 'archivio/2016/squadre1516.inc';
require_once $relocate_string . 'archivio/2016/calendario1516.inc';
require_once $relocate_string . 'archivio/2016/classifica1516.inc.php';

$datiCampionatoFileName = $relocate_string . 'archivio/2016/datiCampionato1516.txt';
?>
...
xmlns="http://www.w3.org/1999/xhtml">
	...
	<!--<body onload="startBanner(1)">-->
		...
		<div id="main">
			...
			<h1 class="title">XVII Campionato Fantacalcio NMR 2015/16</h1>
			<br />
        <br />
        <h2 class='firstClass'>1&deg; Classificato: </h2>
        <h2 class="title">Fedora</h2>
        <br />
