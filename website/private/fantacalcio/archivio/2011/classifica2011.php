<?php 
	$relocate_string = "../../";
	include("squadre1011.inc.php");
	include("calendario1011.inc.php");
	include("classifica1011.inc.php");
?>
...
<script type="text/javascript" src="../../documentPreProcessor.php?document=javascript2011.js&type=javascript"></script>
<!-- InstanceEndEditable -->
</head>
<!-- <body onresize="Count();"> -->
<body>
...
<?php
	 ...
	 */
	$handle = fopen("datiCampionato1011.txt",'r');
