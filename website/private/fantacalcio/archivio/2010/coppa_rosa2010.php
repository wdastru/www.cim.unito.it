...
<tr> 
			...
			<td class="titolare">Galloppa (Parma) </td> 
			<td class="titolare">Ronaldinho (Milan) </td></tr><tr> 
			<td class="riserva">Manninger (Juventus) </td> 
			<td class="titolare">Zambrotta (Milan) </td> 
			<td class="titolare">Ferreira Pinto (Atalanta) </td> 
			<td class="titolare">Cavani (Palermo) </td></tr><tr> 
			<td class="tribuna">De Sanctis (Napoli) </td> 
			<td class="titolare">Balzaretti (Palermo) </td> 
			<td class="titolare">Zapater (Genoa) </td> 
			<td class="titolare">Pellissier (Chievo) </td></tr><tr> 
			<td class="tribuna"></td> 
			<td class="riserva">Zapata (Udinese) </td> 
			<td class="titolare">Valdes (Atalanta) </td> 
			<td class="riserva">Borriello (Milan) </td></tr><tr> 
			<td class="tribuna"></td> 
			<td class="riserva">Paci (Parma) </td> 
			<td class="riserva">Beckham (Milan)</span></td> 
			<td class="riserva">Crespo (Genoa) </td></tr><tr> 
			<td class="tribuna"></td> 
			<td class="tribuna">Zaccardo (Parma) </td> 
			<td class="riserva">Candreva (Livorno) </td> 
			<td class="tribuna">Floccari (Genoa) </td></tr><tr> 
			<td class="tribuna"></td> 
			<td class="tribuna">Bocchetti (Genoa) </td> 
			<td class="tribuna">Mesto (Genoa) </td> 
			<td class="tribuna"></td></tr><tr> 
			<td class="tribuna"></td> 
