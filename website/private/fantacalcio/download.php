...
<?php require $relocate_string . 'include/menu.inc.php'; ?>
	...
	<div id="main">
		...
		<table id='downloads' style="margin: auto; padding: 10px;">
			<tr><td><img class='new' src='figure/new.gif'></td><td class='left'><a href="download/FantaCalcGui_v3.3.3_Setup.exe">FantaCalcGui v3.3.2 (installer)</a></td></tr>
            <tr><td><img class='new' src='figure/new.gif'></td><td class='left'><a href="download/FantaCalcGui_v3.3.3.zip">FantaCalcGui v3.3.2.zip</a></td></tr>
