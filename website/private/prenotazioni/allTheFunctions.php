...
/** 
 * Gets the Month before the specified date.
 *
 * L'ho fatto io! Può non funzionare
 */
function get_onemonth_before ( $year, $month, $day ) {
  return mktime ( 3, 0, 0, $month, $day - 30, $year );
}
