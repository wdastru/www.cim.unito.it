...
if ($_FILES['ufile'] != null) {
	...
	if ($theFileSize > 20000000) {
		...
		if (move_uploaded_file($_FILES['ufile']['tmp_name'], $path)) {
			...
			$mailer -> AddAddress("daniela.dellicastelli@unito.it", "Daniela Delli Castelli");
			$mailer -> AddAddress("valeria.menchise@unito.it", "Valeria Menchise");
			$mailer -> AddAddress("silviettariz@yahoo.it", "Silvia Rizzitelli");
			$mailer -> AddAddress("pierangela.giustetto@unito.it", "Pierangela Giustetto");
			$mailer -> AddAddress("cinzia.boffa@libero.it", "Cinzia Boffa");
			$mailer -> AddAddress("giuseppe.ferrauto@unito.it", "Giuseppe Ferrauto");
			$mailer -> AddAddress("mf.garello@alice.it", "Francesca Garello");
			$mailer -> AddAddress("marta.ruzza@studenti.unito.it", "Marta Ruzza");
			$mailer -> AddAddress("amerigo.pagoto@studenti.unito.it", "Amerigo Pagoto");
			$mailer -> AddAddress("francesca.arena@unito.it", "Francesca Arena");
			$mailer -> AddAddress("rachele.stefania@unito.it", "Rachele Stefania");
			$mailer -> AddAddress("elisa.deluca@unito.it", "Elisa Deluca");
			$mailer -> AddAddress("tinedeveylder@hotmail.com", "Tine De Veylder");
            $mailer -> AddAddress("dupont.aurelie01@gmail.com", "Aurélie Dupont");
            $mailer -> AddAddress("e.chiavazza@gmail.com", "Enrico Chiavazza");
            $mailer -> AddAddress("frederikbp@gmail.com", "Frederik Beauprez");
