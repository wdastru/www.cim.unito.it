				...
				<div id='content-large'>
					<div class='paddingOuter'>
						...
						<div class='paddingInner'>
							<?php
							echo "<form name=\"add\" method=\"post\" action=\"../index.php\">";
							echo "<table>
							<tr>
							<td>
							Name :
							...
							<td>
							<input type='text' size='50' name='newname'/>
							</td>
							</tr>
							<tr>
							<td>
							...
							<td>
							<input type='text' size='50' name='newnote'>
							</td>
							</tr>
							<tr>
							<td>
