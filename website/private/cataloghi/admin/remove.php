                            ...
                            >
                                <table>
                                    ...
                                    <tr>
                                        <td>Note :</td>
                                        <td>
                                            <?php echo $_POST['note2remove']; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>CAS n&deg; :</td>
                                        <td>
                                            <?php echo $_POST['CAS2remove']; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <input
                                    type="hidden"
                                    name="oldquantity"
                                    value="<?php echo mysql_real_escape_string($_POST['quantity2remove']); ?>"
                                />
                                <input
                                    type="hidden"
                                    name="oldlab"
                                ...
                                <input
                                    type="hidden"
                                    name="oldphrase_H"
                                    value="<?php echo mysql_real_escape_string($_POST['phrase_H2remove']); ?>"
                                />
                                <input
                                    type="hidden"
                                    name="oldphrase_R"
                                    value="<?php echo mysql_real_escape_string($_POST['phrase_R2remove']); ?>"
                                />
                                <input
                                    type="hidden"
                                    name="oldlink"
