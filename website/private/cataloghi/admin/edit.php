            ...
            <div id="subsection0">
                ...
                <div id="content-large">
                    <div class="paddingOuter">
                        <div class="band">
                            <h1 class="subsectionTitle">CHEMICALS CATALOG</h1>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                name="newname_UK"
                                                size="70"
                                                maxlength="<?php echo $name_UK_maxlength; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                name="newname_IT"
                                                size="70"
                                                maxlength="<?php echo $name_IT_maxlength; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                type="text"
                                                name="newplace"
                                                maxlength="<?php echo $place_maxlength; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                type="text"
                                                name="newquantity"
                                                maxlength="<?php echo $quantity_maxlength; ?>"
                                                value="<?php echo $_POST['quantity2edit']; ?>"
                                            />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                type="text"
                                                name="newlab"
                                                maxlength="<?php echo $lab_maxlength; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                name="newphrase_H"
                                                maxlength="50"
                                                size="<?php echo $phrase_H_maxlength; ?>"
                                                value="<?php echo $_POST['phrase_H2edit']; ?>"
                                            />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                name="newphrase_R"
                                                maxlength="50"
                                                size="<?php echo $phrase_R_maxlength; ?>"
                                                value="<?php echo $_POST['phrase_R2edit']; ?>"
                                            />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Link to the safety info :</td>
                                        <td class="data scheda">
                                            <a
                                                href="../safety_info/<?php echo $_POST['link2edit']; ?>"
                                                ><?php echo $_POST['link2edit']; ?></a
                                            >
                                        </td>
                                    </tr>
                                    <tr>
