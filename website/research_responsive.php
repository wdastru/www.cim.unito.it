...
<title>Molecular Imaging Center - University of Torino - Responsive
agents</title>
<!-- InstanceEndEditable -->
...
<div id="subsection6"><!-- InstanceEndEditable -->
<?php require('includes/research-side-nav.php'); ?>
<div id='content'>
<div class='paddingOuter'>
<div id='band'>
<h1 id='subsectionTitle'>
<!-- InstanceBeginEditable name="subsection title" -->Responsive
Agents <!-- InstanceEndEditable --></h1>
</div>
<div class='paddingInner'>
<!-- InstanceBeginEditable name="subsection content" -->
<p class='indent'>The MRI responsive agents are substances whose
...
agent.<br />
Two main approaches are followed:</p>
<ul>
<li><b>pH responsive agents</b><br />
<p class="indent">They are agents based on DOTA-type Gd complexes
...
complexes show the same biodistribution.</p>
</li>
