...
echo "
    ...
    <meta name='keywords' content='NMR, MRI, Imaging Molecolare, Molecular Imaging, Imaging, Hyperpolarization, Liposomes, Targeting, Contrast Agents, Positron Emission Tomography, PET, microPET, Diagnostic Imaging, Optical Imaging, CIM, Torino, Italy, Liposomi, risonanza magnetica, Italia' >
    ...
    <script src='" . $localizer . "minified/js/script.js'></script>
";
include $localizer . 'includes/google.inc.php';
?>
